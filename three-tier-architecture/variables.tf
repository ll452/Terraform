...
variable "vpc_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "tf-tta-vpc", "created-by" = "terraform" }
}
...
variable "asg_sg_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "tf-tta-asg-sg", "created-by" = "terraform" }
}
...
variable "asg_image_id" {
  ...
  type        = string
  default     = "ami-026b57f3c383c2eec" #amazon linux ami
}
...
variable "asg_iam_role_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "tf-tta-asg-iam-role", "created-by" = "terraform" }
}
...
variable "asg_instance_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "tf-tta-asg-instance", "created-by" = "terraform" }
}

variable "asg_volume_tags" {
  description = "Auto scaling group volume tags"
  type        = map(string)
  default     = { "Name" = "tf-tta-asg-volume", "created-by" = "terraform" }
}

variable "asg_tags" {
  description = "Auto scaling group tags"
  type        = map(string)
  default     = { "Name" = "tf-tta-asg", "created-by" = "terraform" }
}
...
variable "alb_sg_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "tf-tta-alb-sg", "created-by" = "terraform" }
}
...
variable "alb_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "tf-tta-alb", "created-by" = "terraform" }
}
...
variable "rds_sg_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "tf-tta-rds-sg", "created-by" = "terraform" }
}
...
variable "rds_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "tf-tta-rds", "created-by" = "terraform" }
}
